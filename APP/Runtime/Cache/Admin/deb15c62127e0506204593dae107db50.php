            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                        <div class="row" >
                            <div class="col-xs-12">
                                <form action="/Admin/Homeindex/add.html" method="post" class="form-horizontal form form-builder">
                                    <div class="form-type-list">
                                        ...
                                        <div class="form-group item_title ">
                                            ...
                                            <div class="right">
                                                <input type="number" class="form-control input" name="price" value="" placeholder="请输入金额" >
                                            </div>
                                        </div>
