            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="<?php echo U('Roborder/editup');?>" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                                <label class="left control-label">ID：</label>
                                                <div class="right">
                                                    <input type="hidden" class="form-control input" name="id" value="<?php echo ($olist["id"]); ?>">
                                                </div>
                                            </div>


                                            <div class="form-group">
                                                <label class="left control-label">支付类型：</label>
                                                <div class="right">
                                                    <select name="class" class="form-control cui-select select">
														<?php if($olist['class']==1){?>
															<option  selected="true" value="1">微信支付</option>
															<option   value="2">支付宝支付</option>
															<option   value="3">银行支付</option>
														<?php }elseif($olist['class']==2){?>
															<option  value="1">微信支付</option>
															<option  selected="true"  value="2">支付宝支付</option>
															<option   value="3">银行支付</option>
														<?php }elseif($olist['class']==3){?>
															<option  value="1">微信支付</option>
															<option  value="2">支付宝支付</option>
															<option  selected="true"   value="3">银行支付</option>
														<?php }?>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">支付金额：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="price" value="<?php echo ($olist["price"]); ?>" placeholder="请输入金额" >
                                                </div>
                                            </div>
