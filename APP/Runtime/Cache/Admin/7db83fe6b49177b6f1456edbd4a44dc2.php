            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/Roborder/add.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="price" value="<?php echo ($info["price"]); ?>" placeholder="请输入金额" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">添加单数：</label>
                                                <div class="right">
                                                    <input type="text" class="form-control input" name="num" value="" placeholder="一次性添加单量，输入1为1单，10为1次性10单" >
                                                </div>
                                            </div>
