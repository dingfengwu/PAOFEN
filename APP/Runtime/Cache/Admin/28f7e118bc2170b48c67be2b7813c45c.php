            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                        <div class="row" >
                            <div class="col-xs-12">
                                <form action="/Admin/Homeindex/edit/id/12.html" method="post" class="form-horizontal form form-builder">
                                    ...
                                    <div class="form-type-list">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="right">
                                                <img src="<?php echo ($info["img"]); ?>" id="show" width="100" height="50">
                                        ...
                                        <div class="form-group item_title ">
                                            ...
                                            <div class="right">
                                                <input type="text" class="form-control input" name="name" value="<?php echo ($info["name"]); ?>" placeholder="请输入游戏名称" >
                                            </div>
                                        </div>
                                        <div class="form-group item_title ">
                                            <label class="left control-label">金额：</label>
                                            <div class="right">
                                                <input type="number" class="form-control input" name="price" value="<?php echo ($info["price"]); ?>" placeholder="请输入金额" >
                                            </div>
                                        </div>
