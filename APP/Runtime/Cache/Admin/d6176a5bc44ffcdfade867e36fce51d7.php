...
<body class="admin_config_group" >
    ...
    <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        ...
        <ul class="breadcrumb">
            ...
            <li class="text-muted">系统 / 首页管理 / 首页数据显示</li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 button-list clearfix">
                                <div class="form-group">
                                    <a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo U('Homeindex/add');?>">新增</a>&nbsp;
                                </div>
                            </div>
                                    ...
                                    <div class="panel panel-default table-responsive">
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                    ...
                                                    <td><img src="<?php echo ($data["img"]); ?>" width="50px" height="50px"></td>
                                                    <td><?php echo ($data["name"]); ?></td>
                                                    <td><?php echo ($data["price"]); ?></td>
                                                    <td>
                                                        <a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo U('Homeindex/edit',array('id'=>$data['id']));?>">编辑</a>

                                                        <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Manage" href="<?php echo U('Homeindex/del',array('id'=>$data['id']));?>">删除</a>
