...
<body class="admin_config_group" >
   ...
   <div id="main" class="col-xs-12 col-sm-9 main" style="overflow-y: scroll;">
        <ul class="breadcrumb">
            ...
            <li class="text-muted">会员管理 /  会员权限</li>
            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/Admin/User/restrict/userid/9.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
											...
											<div class="form-group item_title ">
                                                <label class="left control-label">提现状态：</label>
                                                <div class="right">
													<?php if($info['tx_status'] == 1){?>
													<span style="font-size:12px;color:green;">允许</span>
													<?php }else{?>
													<span style="font-size:12px;color:red;">禁止</span>
													<?php }?>
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <div class="auth3" style="line-height:120%;" >
													...
													<label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
														<input type="checkbox" name="tx_status"  value="1">
