            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                        <div class="row" >
                            <div class="col-xs-12">
                                <form action="/Admin/Hyxz/edit/id/4.html" method="post" class="form-horizontal form form-builder">
                                    ...
                                    <div class="form-type-list">
                                        ...
                                        <div class="form-group item_title ">
                                            ...
                                            <div class="right">
                                                <input type="text" class="form-control input" name="title" value="<?php echo ($info["title"]); ?>" placeholder="请输入标题" >
                                            </div>
                                        </div>
                                        <div class="form-group item_title ">
                                            <label class="left control-label">内容：</label>
                                            <div class="right">
                                                <textarea name="content" style="width:100%;height:200px;"><?php echo ($info["content"]); ?></textarea>
                                            </div>
                                        </div>
