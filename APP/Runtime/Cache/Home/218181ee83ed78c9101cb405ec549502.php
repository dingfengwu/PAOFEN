...
<div id="tabbar-with-contact" class="mui-control-content mui-active">
    ...
    <div class="title" style="margin-top: 75px;color:#ffffff;text-align: center;"><?php echo ($info["title"]); ?></div>
    <div class="title" style="margin-top: 20px;color:#ffffff;text-align: left; padding: 0 10%;"><?php echo ($info["content"]); ?></div>
</div>
