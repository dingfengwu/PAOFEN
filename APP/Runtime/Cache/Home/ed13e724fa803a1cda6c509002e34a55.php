	...
	<div id="tabbar-with-contact" class="mui-control-content mui-active">
		...
		<ul class="mui-table-view ullist">
			...
			<li class="mui-table-view-cell mui-collapse-content">
				...
				<a href="<?php echo U('Recharge/chongzhi');?>" class="mui-navigate-right" style=" margin-left: 10%;font-size: 0.9em; bottom: 4px; ">
					充值管理
				</a>
			</li>
			<li class="mui-table-view-cell mui-collapse-content">
				...
				<a href="<?php echo U('Withdraw/tixian');?>" class="mui-navigate-right" style=" margin-left: 10%; font-size: 0.9em;bottom: 4px; ">
					提现管理
				</a>
			</li>
			<li class="mui-table-view-cell mui-collapse-content">
			...
			<li class="mui-table-view-cell mui-collapse-content">
				<img src="../Public/home/wap/images/erweima.png" class="imglist">
				<a href="<?php echo U('User/hyxz');?>" class="mui-navigate-right" style=" margin-left: 10%; font-size: 0.9em;bottom: 4px; ">
					会员须知
				</a>
			</li>
			<li class="mui-table-view-cell mui-collapse-content">
